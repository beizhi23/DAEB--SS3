...
class Dataset:
    ...
    @staticmethod
    def load_from_files(data_path: object, folder_label: object = True, as_single_doc: object = False, sep_doc: object = '\n') -> object:
        r"""
        ...
        f = open(
            "C:/Users/GYM/Desktop/大创与互联网+：基于集成学习的心理状态分析与评测系统/代码/ss3 and t-ss3/stopwords.txt",
            "r", encoding='utf-8')
        stopwords = []
        ...
        lendata = len(x_data)
        datapop=[]
        for w in range(0, lendata - 1):
            if x_data[w] in stopwords:
                datapop.append(w)
